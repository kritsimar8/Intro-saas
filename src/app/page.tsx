import { CardBody, CardContainer, CardItem } from "../components/global/3d-card-container";
  ...
  return (
    <main>
      ...
      <section className="h-screen w-full bg-neutral-950 rounded-md !overflow-visible relative flex flex-col items-center antialiased">
        <div className="absolute inset-0 h-full w-full items-center px-5 py-14 [background:radial-gradient (125%_125%_at_50%_10%,#000_35%,#223_100%)]">
        <div className=" flex flex-col mt-[-100px] md:mt-[-50%] lg:mt-[-0%]">
        <ContainerScroll
        titleComponent={
      ...
      <InfiniteMovingCards
      className="md:mt-[18rem] mt-[-100px] lg:mt-[25rem] "
      items={clients}
      direction="right"
      speed="slow"
      />
